...
public class BoardModifyServlet extends HttpServlet {
	...
	// 자바에서 서블릿 객체를 톰캣에게 전달할 때도 Byte 단위로 전송
	// 이 때도 직렬화 하는데 이때 필요
	...
	protected void doGet(HttpServletRequest request, 
		...
		// boardView.jsp => "get" => parameter 값들을 저장할 객체 전달되는 parameter 명 : no
		...
		RequestDispatcher rd = request.getRequestDispatcher("boardModity.jsp");
