	...
	<form action="${contextPath}/boardModify" method="post">
		...
		<table border="1" summary="게시글 수정 폼">
			...
			<tbody>
				...
				<tr>
					<td colspan="2"><textarea name="contents" cols="80" rows="10">${board.contents}</textarea></td>
				</tr>
			</tbody>
		</table>
		<p>
			<input type="button" value="글 목록" onclick="location.href='${contextPath}/boardList'"/>
